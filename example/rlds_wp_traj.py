...
# # # ============================================================
# # # 0. Mock mujoco_py / glfw / robosuite（必须在 import AWE 之前）
# # #    因为 traj_reconstruction.py 顶层 import 了 robosuite
# # # ============================================================
...
# # for episode in dataset.skip(N - 1).take(1):
# for episode in dataset.take(1):
...
#     # ============================================================
#     # 3. 用 AWE 提取 Waypoints
#     # ============================================================
#     err_threshold = 0.001  # 单位: 米。越小 waypoints 越多越精确

#     print(f"\n提取 Waypoints (err_threshold={err_threshold})...")
#     waypoints = dp_waypoint_selection(
#         env=None,
#         actions=ee_positions,       # (T, 3) 的 EE xyz
#         gt_states=ee_positions,     # (T, 3) 的 EE xyz
...
#     ax.set_title(
#         f"Left Arm EE Trajectory\n"
#         f"{T} frames → {len(waypoints)} waypoints "
#         f"(threshold={err_threshold}m)",
#         fontsize=13
#     )
...
#                ncol=2, fontsize=12)
#     fig.suptitle(
#         f"Left Arm EE: {T} frames → {len(waypoints)} waypoints "
#         f"(threshold={err_threshold}m)", fontsize=15, fontweight='bold')
#     plt.tight_layout()
...
#     fig.suptitle("Left Arm EE: Original vs Waypoint Reconstruction", fontsize=15)
...
#     thresholds = [0.005, 0.003, 0.002, 0.001, 0.0005]
#     n_th = len(thresholds)
#     t = np.arange(T)

#     # 预先计算所有 threshold 的 waypoints
#     all_wp_results = {}
...
#     fig.suptitle("XYZ Reconstruction Comparison across Thresholds", fontsize=16, y=1.02)
...
for episode in dataset.take(1):
    ...
    # ============================================================
    err_threshold = 0.005  # 单位: rad (joint space)。越小 waypoints 越多越精确  # <-- 修改注释
